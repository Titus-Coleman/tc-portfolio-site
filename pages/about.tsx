...
function About(props: Props) {
  return (
    <div className={styles.aboutPage}>
      <hr id="about" className={styles.hr} />
      <section className={styles.aboutContainer}>
        <h3 className={styles.aboutTitle}>About</h3>
        <div className={styles.aboutGrid}>
          <div className={styles.aboutText}>
            <p>
              I started my tech career as a Sys Admin getting familiar with PHP and SQL on the job.
              After a few too many nights in cold server rooms and numerous DDoS attacks, I ventured
              outside of tech professionally, but I never truly left in my personal life. I realized
              my passion was to make an <span>impact</span> but also have fun in my career, so I
              learned to code.
            </p>
            <p>
