...
function Hero({ pageInfo }: Props) {
  const [text, count] = useTypewriter({
    words: ['relentless learner.', 'builder.', 'I 💗 simple UIs.', '...and Cortados! ☕'],
    loop: true,
    delaySpeed: 2000,
  });
    ...
    <section id="hero" className={styles.hero_container}>
      ...
      <div className={styles.heroInfo}>
        ...
        <div className={styles.hero_btn_group}>
          <Link href="#skills" className={styles.hero_button}>
            Skills
          </Link>
          <Link href="#projects" className={styles.hero_button}>
            Projects
          </Link>
          <Link href="#about" className={styles.hero_button}>
            About
          </Link>
      ...
      <Link href="#skills" className={styles.arrows}>
        <svg>
